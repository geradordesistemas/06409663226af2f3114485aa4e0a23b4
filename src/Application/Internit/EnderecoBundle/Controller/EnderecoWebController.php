...
use App\Application\Internit\EnderecoBundle\Form\EnderecoType;
...
#[Route('/web/endereco', name: 'web_endereco_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Endereco', description: 'Permissões do modulo Endereco')]
class EnderecoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_endereco_';
    }
    ...
    {
        return "@ApplicationInternitEndereco/endereco/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Endereco')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar Endereco',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Endereco')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Endereco();
        $form = $this->createForm(EnderecoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar Endereco',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Endereco')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar Endereco',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Endereco')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Endereco')]
