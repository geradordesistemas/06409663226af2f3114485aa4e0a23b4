...
use App\Application\Internit\ObjetivoBundle\Form\ObjetivoType;
...
#[Route('/web/objetivo', name: 'web_objetivo_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Objetivo', description: 'Permissões do modulo Objetivo')]
class ObjetivoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_objetivo_';
    }
    ...
    {
        return "@ApplicationInternitObjetivo/objetivo/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Objetivo')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar Objetivo',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Objetivo')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Objetivo();
        $form = $this->createForm(ObjetivoType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Objetivo')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar Objetivo',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Objetivo')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Objetivo')]
