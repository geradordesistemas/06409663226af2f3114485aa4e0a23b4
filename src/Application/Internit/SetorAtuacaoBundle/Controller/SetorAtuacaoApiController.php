...
#[Route('/api/setorAtuacao', name: 'api_setorAtuacao_')]
#[OA\Tag(name: 'SetorAtuacao')]
#[ACL\Api(enable: true, title: 'SetorAtuacao', description: 'Permissões do modulo SetorAtuacao')]
class SetorAtuacaoApiController extends BaseApiController
{

    public function getClass(): string
    {
        return SetorAtuacao::class;
    }
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — SetorAtuacao.
     * Recupera a coleção de recursos — SetorAtuacao.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos SetorAtuacao',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar SetorAtuacao')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — SetorAtuacao.
     * Cria o Recurso — SetorAtuacao.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso SetorAtuacao',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar SetorAtuacao')]
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera o recurso — SetorAtuacao.
     * Recupera o recurso — SetorAtuacao.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
        response: 200,
        description: 'Retorna recurso SetorAtuacao',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar SetorAtuacao')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'SetorAtuacao não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — SetorAtuacao.
     * Substitui o recurso — SetorAtuacao.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar SetorAtuacao')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar SetorAtuacao')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'SetorAtuacao removido com sucesso.'], 204);
    }
