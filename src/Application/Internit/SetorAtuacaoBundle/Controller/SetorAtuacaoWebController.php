...
use App\Application\Internit\SetorAtuacaoBundle\Form\SetorAtuacaoType;
...
#[Route('/web/setorAtuacao', name: 'web_setorAtuacao_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'SetorAtuacao', description: 'Permissões do modulo SetorAtuacao')]
class SetorAtuacaoWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_setorAtuacao_';
    }
    ...
    {
        return "@ApplicationInternitSetorAtuacao/setoratuacao/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista SetorAtuacao')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar SetorAtuacao',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria SetorAtuacao')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new SetorAtuacao();
        $form = $this->createForm(SetorAtuacaoType::class, $data);
        ...
        return $this->render($this->getBaseTemplate() . 'create.html.twig',[
            'title' => 'Criar SetorAtuacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/show', name: 'show', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza SetorAtuacao')]
    public function showAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'show.html.twig',[
            'title' => 'Visualizar SetorAtuacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'edit', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita SetorAtuacao')]
    public function editAction(ManagerRegistry $doctrine, Request $request, int $id): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'edit.html.twig',[
            'title' => 'Editar SetorAtuacao',
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/delete', name: 'delete', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta SetorAtuacao')]
