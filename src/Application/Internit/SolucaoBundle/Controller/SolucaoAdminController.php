...
#[ACL\Admin(enable: true, title: 'Solucao', description: 'Permissões modulo Solucao')]
class SolucaoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Solucao')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Solucao')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Solucao')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Solucao')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Solucao')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Solucao em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Solucao')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Solucao')]
