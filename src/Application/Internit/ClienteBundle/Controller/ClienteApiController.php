...
class ClienteApiController extends BaseApiController
{
    ...
    #[OA\Response(
        ...
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(property: 'setorAtuacao', type: 'array', items: new OA\Items(type: 'integer') ),
            ],
            type: 'object'
        )
    )]
    ...
    public function createAction(Request $request): Response
    {
        ...
        $object = $this->objectTransformer->JsonToObject( $this->getClass(), $request , [
            'nome', 'descricao', 'logo', 'setorAtuacao', 
        ]);
