<?php
namespace App\Application\Internit\CargoBundle\Admin;
...
final class CargoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof Cargo ? $object->getId().''
