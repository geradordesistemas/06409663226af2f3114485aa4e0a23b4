...
#[ACL\Admin(enable: true, title: 'Cargo', description: 'Permissões modulo Cargo')]
class CargoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Cargo')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Cargo')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Cargo')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Cargo')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Cargo')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Cargo em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Cargo')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Cargo')]
