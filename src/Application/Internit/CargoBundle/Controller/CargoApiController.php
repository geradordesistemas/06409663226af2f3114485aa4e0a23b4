...
use App\Application\Internit\CargoBundle\Repository\CargoRepository;
...
#[Route('/api/cargo', name: 'api_cargo_')]
#[OA\Tag(name: 'Cargo')]
#[ACL\Api(enable: true, title: 'Cargo', description: 'Permissões do modulo Cargo')]
class CargoApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Cargo.
     * Recupera a coleção de recursos — Cargo.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Cargo',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar Cargo')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Cargo.
     * Cria o Recurso — Cargo.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Cargo',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'cargo', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Cargo')]
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Cargo')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Cargo não encontrado!'], 404);
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Cargo')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Cargo')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Cargo removido com sucesso.'], 204);
    }
