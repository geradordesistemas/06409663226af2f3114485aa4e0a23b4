...
use App\Application\Internit\ContatoBundle\Form\ContatoType;
...
#[Route('/web/contato', name: 'web_contato_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Contato', description: 'Permissões do modulo Contato')]
class ContatoWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitContato/contato/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Contato')]
    public function listAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        return $this->render($this->getBaseTemplate() . 'list.html.twig', [
            'title' => 'Listar Contato',
            'objects' => $filter->getResult()->data,
        ]);
    }

    #[Route('/create', name: 'create', methods: ['GET', 'POST'])]
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Contato')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Contato();
        $form = $this->createForm(ContatoType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Contato')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Contato')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Contato')]
